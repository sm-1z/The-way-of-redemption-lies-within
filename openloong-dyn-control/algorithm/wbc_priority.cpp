...
void WBC_priority::computeTau() {
    ...
    // std::cout<<"success"<<std::endl<<stance_fe_rot_cur_W<<std::endl;
...
//            kin_tasks_walk.taskLib[id].dJ.block(0,22,3,3).setZero();
        ...
        #if FIX == true // * YKB
        kin_tasks_walk.taskLib[id].errX = Eigen::VectorXd::Zero(3);
        kin_tasks_walk.taskLib[id].errX(0) = 0 - q(Joint_waist_pitch);
        kin_tasks_walk.taskLib[id].errX(1) = 0 - q(Joint_waist_roll);
        kin_tasks_walk.taskLib[id].errX(2) = 0 - q(Joint_waist_yaw);
        kin_tasks_walk.taskLib[id].derrX = Eigen::VectorXd::Zero(3);
        kin_tasks_walk.taskLib[id].ddxDes = Eigen::VectorXd::Zero(3);
        kin_tasks_walk.taskLib[id].dxDes = Eigen::VectorXd::Zero(3);
        kin_tasks_walk.taskLib[id].kp = Eigen::MatrixXd::Identity(3, 3) * 200;
        kin_tasks_walk.taskLib[id].kd = Eigen::MatrixXd::Identity(3, 3) * 20;
        kin_tasks_walk.taskLib[id].J = Eigen::MatrixXd::Zero(3, model_nv);
        kin_tasks_walk.taskLib[id].J(0, Joint_waist_pitch-1) = 1;
        kin_tasks_walk.taskLib[id].J(1, Joint_waist_roll-1) = 1;
        kin_tasks_walk.taskLib[id].J(2, Joint_waist_yaw-1) = 1;
...
//        kin_tasks_walk.taskLib[id].derrX=-Jsw*dq;
        ...
        kin_tasks_walk.taskLib[id].J.block(0,Joint_waist_yaw-1,6,3).setZero(); // exculde waist joints
        kin_tasks_walk.taskLib[id].dJ = dJsw;
        kin_tasks_walk.taskLib[id].dJ.block(0,Joint_waist_yaw-1,6,3).setZero(); // exculde waist joints
#elif FIX == false
        kin_tasks_walk.taskLib[id].J = Jsw;
...
#if FIX == true // * YKB
        double l_hip_pitch = q(Joint_hip_pitch_l) - qIniDes(Joint_hip_pitch_l);
        double r_hip_pitch = q(Joint_hip_pitch_r) - qIniDes(Joint_hip_pitch_r);
#elif FIX == false
        double l_hip_pitch = q(Joint_hip_pitch_l) - qIniDes(Joint_hip_pitch_l);
        double r_hip_pitch = q(Joint_hip_pitch_r) - qIniDes(Joint_hip_pitch_r);
#endif
...
//        kin_tasks_stand.taskLib[id].W.diagonal() = Eigen::VectorXd::Ones(model_nv);
...
#if FIX == true // * YKB
        kin_tasks_stand.taskLib[id].J.block(0,Joint_waist_yaw-1,12,3).setZero(); // exculde waist joints
#elif FIX == false
        kin_tasks_stand.taskLib[id].J.block(0,22,12,3).setZero(); // exculde waist joints
#endif
...
#if FIX == true // * YKB
        kin_tasks_stand.taskLib[id].J.block(0,Joint_waist_yaw-1,3,3).setZero(); // exculde waist joints
        kin_tasks_stand.taskLib[id].J.block(0,Joint_shouder_pitch_l-1,3,28).setZero(); //exculde arm joints
#elif FIX == false
        ...
        kin_tasks_stand.taskLib[id].J.block(0,Joint_waist_yaw-1,1,3).setZero();
        kin_tasks_stand.taskLib[id].dJ = taskMap * dJ_base;
        kin_tasks_stand.taskLib[id].dJ.block(0,Joint_waist_yaw-1,1,3).setZero();
...
#if FIX == true // * YKB
        kin_tasks_stand.taskLib[id].J.block(0,Joint_shouder_pitch_l-1,2,28).setZero();
#elif FIX == false
...
//            kin_tasks_stand.taskLib[id].derrX.block(2,0,3,1)=-taskMapRPY*J_hip_link*dq;
        ...
        // * YKB
        kin_tasks_stand.taskLib[id].W.diagonal()(Joint_waist_pitch-1)=200;
        kin_tasks_stand.taskLib[id].W.diagonal()(Joint_waist_roll-1)=200;
...
#if FIX == true // * YKB
        kin_tasks_stand.taskLib[id].J.block(0,Joint_shouder_pitch_l-1,14,28)=Eigen::MatrixXd::Identity(14,14);
#elif FIX == false
        ...
        // * YKB
        kin_tasks_stand.taskLib[id].errX(0) = 0 - q(Joint_waist_pitch);
        kin_tasks_stand.taskLib[id].errX(1) = 0 - q(Joint_shouder_roll_l);
        kin_tasks_stand.taskLib[id].errX(2) = 0 - q(Joint_shouder_yaw_l);
        ...
        // * YKB
        kin_tasks_stand.taskLib[id].J(0, Joint_waist_pitch-1) = 1;
        kin_tasks_stand.taskLib[id].J(1, Joint_waist_roll-1) = 1;
        kin_tasks_stand.taskLib[id].J(2, Joint_wrist_yaw_l-1) = 1;
